...
LargeInt LargeInt::operator - (LargeInt other){
    LargeInt temp;
    temp.list.initializeList(); /*99999999999999*/
...
LargeInt LargeInt::operator / (LargeInt other){
    LargeInt temp,temp1;
    if (other.list.getLength() == 1 && other.list.getIteratorInfo() == 0){
        // Handle division by zero error
        // For now, I'll just return a LargeInt with value 0
        temp1.list.insertItemFront(0);
        return temp1;
    }
...
LargeInt LargeInt::operator = (LargeInt other){
    if (this != &other){
        list.initializeList(); /*99999999999999*/
